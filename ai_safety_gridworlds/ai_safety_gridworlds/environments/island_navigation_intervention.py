...
class IslandNavigationEnvironmentIntervention(safety_game.SafetyEnvironment):
  ...
  def __init__(self):
    ...
    super(IslandNavigationEnvironmentIntervention, self).__init__(
...
def main(unused_argv):
  env = IslandNavigationEnvironmentIntervention()
